...
```mermaid
flowchart TD
    A[🚀 Start Here] --> B[01 · What is an Agent?]
    B --> C[02 · Anatomy of an Agent]
    C --> D[03 · How Agents Think]
    D --> E[04 · Types of Agents]
    E --> F[05 · Glossary]

    B -.->|confused by a word?| F
    C -.->|confused by a word?| F
    D -.->|confused by a word?| F
